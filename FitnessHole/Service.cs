...
namespace FitnessHole
{
    ...
    public partial class Service
    {
        ...
        public Service()
        {
            ...
            this.OrderDetailsServices = new HashSet<OrderDetailsService>();
        }
    
        public int Id { get; set; }
        public string ServiceName { get; set; }
        public decimal PricePerHours { get; set; }
        public decimal LimitlessPrice { get; set; }
        public Nullable<bool> Status { get; set; }
    
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<ServicesToPackage> ServicesToPackages { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<OrderDetailsService> OrderDetailsServices { get; set; }
    }
}
